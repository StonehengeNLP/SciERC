...
_predict_names = [
    "candidate_starts", "candidate_ends", "candidate_arg_scores", "candidate_pred_scores", "ner_scores", "arg_scores",
    "pred_scores",
            ...
            while True:
                ...
                for examples in doc_examples:
                    ...
                    if self.config["batch_size"] == -1:
                        ...
                        for tensor_example in tensor_examples:
                            feed_dict = dict(
                                list(zip(self.queue_input_tensors, [tensor_example[tn] for tn in tensor_names])))
                            session.run(self.enqueue_op, feed_dict=feed_dict)
